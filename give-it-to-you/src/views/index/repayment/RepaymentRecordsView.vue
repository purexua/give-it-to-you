<template>
  <div>
    <el-table :data="tableData" style="width: 100%" :row-class-name="tableRowClassName">
      ...
      <el-table-column prop="installment" label="已还期数">
      </el-table-column>
      <el-table-column prop="actualAmount" label="已还金额" width="180">
      </el-table-column>
      <el-table-column prop="paymentDate" label="支付日期" :formatter="formatDate" width="180">
      </el-table-column>
